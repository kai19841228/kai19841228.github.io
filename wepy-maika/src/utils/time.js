...
const time = {
  ...
  getDateValue (dt) {
    ...
    let dt_weeHours = new Date(`${dt.getFullYear()}/${formatNumber(dt.getMonth() + 1)}/${formatNumber(dt.getDate())}`)
    // console.log('dt_weeHours:', `${dt.getFullYear()}/${formatNumber(dt.getMonth() + 1)}/${formatNumber(dt.getDate())}`)
    return dt_weeHours.getTime()
  }
}
