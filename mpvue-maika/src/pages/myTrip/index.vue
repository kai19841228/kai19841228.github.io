...
<view class="container">
  ...
  <view class="page-section-spacing" v-if="type == 1">
    <scroll-view scroll-y="true" style="height: 100%;box-sizing: border-box;padding-top: 100rpx;" @scrolltoupper="PullDown" @scrolltolower="ReachBottom">
...
export default {
  ...
  mounted () {
    mpvue.setNavigationBarTitle({ title: '我的行程' })
  }
}
</script>
